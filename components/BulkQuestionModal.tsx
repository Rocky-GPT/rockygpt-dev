...
const LAST_RUN_STORAGE_KEY = 'rockygpt_dev_bulk_last_run_v3';

/**
 * The pause between questions.
 *
 * `0` leads and is the default here, where the student app started at 1.5s: the
 * delays existed to let a typewriter animation finish and a reader keep up, and
 * neither happens in this app. What remains is rate-shaping for a brain you do
 * not want to hammer, which is a choice rather than a requirement.
 */
const DELAY_OPTIONS = [
  ...
  return (
    <div className={MODAL_OVERLAY} onClick={onClose}>
      <div
        ...
        className="relative flex w-full max-w-2xl max-h-[90vh] flex-col rounded-2xl border border-border bg-background shadow-2xl overflow-hidden"
