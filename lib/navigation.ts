    ...
    items: [
      {
        ...
        status: 'ready',
        upstream: '/readiness + /v1/capabilities + /v1/admin/logs',
      },
      {
        href: '/roadmap',
        label: 'Roadmap',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Radio,
        status: 'ready',
        upstream: '/v1/directory, /map, /shuttle, /menu, /dining-hours',
      },
      {
        href: '/data/releases',
        label: 'Releases',
    ...
    items: [
      {
        ...
        icon: ScrollText,
        status: 'ready',
        upstream: 'GET /v1/admin/logs + stream + feedback',
      },
      {
        ...
        icon: MessageSquareCode,
        status: 'partial',
        upstream: 'rides inside log rows; no dedicated endpoint, no aggregation',
      },
      {
        href: '/quality/evals',
        label: 'Eval Runs',
    ...
    items: [
      {
        ...
        icon: Gauge,
        status: 'ready',
        upstream: '/readiness, /readiness/chat-logs, /health',
      },
      {
