...
export type GraphScope = { recordId?: string; label?: string; collection?: string; entityId?: string; reference?: { source_key: string; source_record_key: string; source_record_id?: string } };
